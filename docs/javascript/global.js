...
<div id="toTopBtn"
  class="fixed bottom-5 right-5 z-40 w-12 h-12 rounded-full bg-[#0a2463] text-white flex items-center justify-center cursor-pointer shadow-lg transition-all duration-500 opacity-0 translate-y-4 pointer-events-none hover:bg-[#0a2463]/80">
