...
<div id="toTopBtn"
  class="fixed bottom-5 left-5 z-40 w-12 h-12 rounded-full bg-slate-950 text-white flex items-center justify-center cursor-pointer shadow-lg transition-all duration-500 opacity-0 translate-y-4 pointer-events-none hover:bg-slate-950/80">
